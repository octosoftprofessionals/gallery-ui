const config = {
  ...
  MARKETPLACE_IFRAME_EMBED_LINK: process.env.GATSBY_MARKETPLACE_IFRAME_EMBED_LINK ?? 'https://opensea.io/collection/metxr?embed=true',
  CONTACT_EMAIL: process.env.GATSBY_CONTACT_EMAIL ?? 'metxr@protonmail.com',
  AIRTABLE_EMBED_SRC: process.env.GATSBY_AIRTABLE_EMBED_SRC ?? 'https://airtable.com/embed/shr8HBrZjylr7c5cp?backgroundColor=gray',
