        ...
        >
          <Grid item xs={12} sm={5} md={4}>
            <Typography variant="h3" color="primary">
              <Grid container direction="collum" className={classes.coverTitle}>
            ...
            >
              ...
              that puts power in the hands of creators. In the new creative
              economy, we all rise up together.
            </Typography>
          ...
          <Grid item xs={12} sm={5} md={4}>
            ...
            <Typography color="primary" className={classes.titlePrice}>
              <Grid container direction="collum">
                <span>
                  If you want to join the creator octosoft, set up and verify
                  your profile. Add your name to de Community Upvote.
                </span>
                <span>
                  If you are a verified community member, log into your account,
                  review the creator list, and raise up the artist whose work
